...
module.exports = {
  ...
  client: env.CLIENT_CONF ? env.CLIENT_CONF.split(',') : [ "organization name", "locale", "protocol", "host", "google analytics tracking id", "logo", "logo mobile", "redirectUrl", "deploymentDomain", "maintenance" ],
