...
var log = require('debug')('hub:db-api:user');
...
exports.updateUsername = function updateUsername(id, newUsername, fn) {
...
exports.exists = function exists(username, fn) {
  username = normalize(username);
  User.findOne({ username: username }, function(err, user) {
    return err ? fn(err) : fn(null, !!user);
  });
};
