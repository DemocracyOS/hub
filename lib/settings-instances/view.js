...
var InstanceRow = require('./instance-row-view');
var t = require('t');
var template = require('./template');
var button = require('./new-instance-button');
  ...
  function onresponse(err, res) {
    ...
    if (instances.length) {
      res.body.forEach(function (instance) {
        ...
        self.find('.instances').append(row.el);
      })
    } else {
      self.find('.instances').append(render(button));
    }
  }
}
